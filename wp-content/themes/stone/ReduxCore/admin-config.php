<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'HotStone Options', 'redux-framework-demo' ),
        'page_title'           => __( 'HotStone Options', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'general',
        'desc'             => __( 'Theme general Settengs!', 'redux-framework-demo' ),
        ...
        'fields'           => array(
            ...
            array(
                'id' => 'personal_image',
                'type' => 'media',
                'title' => esc_html__('Image', 'Galileo'),
                'preview' => true,
                "url" => true,
            ),
            array(
                'id' => 'personal_banner',
                'type' => 'media',
                'title' => esc_html__('Banner Image', 'Galileo'),
                'preview' => true,
                "url" => true,
            ),
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Header Section', 'Galileo' ),
        'id'               => 'header',
        ...
        'fields'           => array(
            array(
                'id' => 'site_logo',
                'type' => 'media',
                'title' => esc_html__('Site Logo', 'Galileo'),
                'default' => array("url" => esc_url( esc_html__( get_template_directory_uri() . "/img/logo.png", 'Galileo' ))),
                'preview' => true,
                "url" => true
            ),
            array(
                'id' => 'light_logo',
                'type' => 'media',
                'title' => esc_html__('Light Logo', 'Galileo'),
                'default' => array("url" => esc_url( esc_html__( get_template_directory_uri() . "/img/logo.png", 'Galileo' ))),
                'preview' => true,
                "url" => true
            ),
            ...
            array(
                'id' => 'main_banner',
                'type' => 'media',
                'title' => esc_html__('Banner', 'Galileo'),
                //'default' => array("url" => esc_url( esc_html__( get_template_directory_uri() . "/img/favicon.png", 'Galileo' ))),
                'subtitle' => __( '1600x395', 'Galileo' ),
                'preview' => true,
                "url" => true
            ),
            array(
                'id' => 'favicon',
                'type' => 'media',
                'title' => esc_html__('Favicon', 'Galileo'),
                //'default' => array("url" => esc_url( esc_html__( get_template_directory_uri() . "/img/favicon.png", 'Galileo' ))),
                'preview' => true,
                "url" => true
            ),
            array(
                'id' => 'apple-touch-icon',
                'type' => 'media',
                'title' => esc_html__('Apple Touch Icon', 'Galileo'),
                //default' => array("url" => esc_url( esc_html__( get_template_directory_uri() . "/img/favicon.png", 'Galileo' ))),
                'subtitle' => __( '60x50', 'Galileo' ),
                'preview' => true,
                "url" => true
            ),
            array(
                'id' => 'apple-touch-icon1',
                'type' => 'media',
                'title' => esc_html__('Apple Touch Icon', 'Galileo'),
                //'default' => array("url" => esc_url( esc_html__( get_template_directory_uri() . "/img/favicon.png", 'Galileo' ))),
                'subtitle' => __( '72x72', 'Galileo' ),
                'preview' => true,
                "url" => true
            ),
            array(
                ...
                'title' => esc_html__('Apple Touch Icon', 'Galileo'),
                //'default' => array("url" => esc_url( esc_html__( get_template_directory_uri() . "/img/favicon.png", 'Galileo' ))),
                'subtitle' => __( '114x114', 'Galileo' ),
                'preview' => true,
                "url" => true
            ),
            array(
                'id' => 'apple-touch-icon3',
                'type' => 'media',
                'title' => esc_html__('Apple Touch Icon', 'Galileo'),
                //'default' => array("url" => esc_url( esc_html__( get_template_directory_uri() . "/img/favicon.png", 'Galileo' ))),
                'subtitle' => __( '144x144', 'Galileo' ),
                'preview' => true,
                "url" => true
            ),
        )
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Social Section', 'Galileo' ),
        'id'               => 'social',
        //'desc'             => __( 'These are really basic fields!', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        ...
        'fields' => array(
            ...
            array(
                ...
                'type' => 'text',
                'title' => esc_html__('Facebook', 'Galileo'),
                'default' => "#"
            ),
            array(
                'id' => 'section_social_twitter',
                'type' => 'text',
                'title' => esc_html__('Twitter', 'Galileo'),
                'default' => "#"
            ),
            array(
                'id' => 'section_social_linkedin',
                'type' => 'text',
                'title' => esc_html__('Linked In', 'Galileo'),
                'default' => "#"
            ),
            array(
                'id' => 'section_social_flickr',
                'type' => 'text',
                'title' => esc_html__('Flickr', 'Galileo'),
                'default' => "#"
            ),
           array(
               'id' => 'section_social_google',
               'type' => 'text',
               'title' => esc_html__('Google Plus', 'Galileo'),
               'default' => "#"
           ),
            array(
                'id' => 'section_social_youtube',
                'type' => 'text',
                'title' => esc_html__('Youtube', 'Galileo'),
                'default' => "#"
            ),
            array(
                'id' => 'section_social_instagram',
                'type' => 'text',
                'title' => esc_html__('Instagram', 'Galileo'),
                'default' => ""
            ),
            array(
                'id' => 'section_social_pinterest',
                'type' => 'text',
                'title' => esc_html__('Pinterest', 'Galileo'),
                'default' => ""
            ),
//            array(
//                'id' => 'section_social_vimeo',
//                'type' => 'text',
//                'title' => esc_html__('Vimeo', 'Galileo'),
//                'default' => ""
//            ),
            array(
                'id' => 'section_social_rss',
                'type' => 'text',
                'title' => esc_html__('RSS', 'Galileo'),
                'default' => ""
            ),
            array(
                'id' => 'section_social_dribbble',
                'type' => 'text',
                'title' => esc_html__('Dribbble', 'Galileo'),
                'default' => ""
            ),
        )
    ));
    Redux::setSection( $opt_name, array(
        'title' => esc_html__('Home Section', 'Galileo'),
    ...
    Redux::setSection( $opt_name, array(
        'title' => esc_html__('Footer Section', 'Galileo'),
        'icon_class' => 'icon-large',
        'icon' => 'el-icon-edit',
        'fields' => array(
            array(
                'id' => 'about_title',
                'type' => 'text',
                'title' => esc_html__('Title', 'Galileo'),
                'default' => ""
            ),
            array(
                'id' => 'about_intro',
                'type' => 'textarea',
                'title' => esc_html__('Intro', 'Galileo'),
                'default' => ""
            ),
            array(
                'id' => 'hide_footer',
                'type' => 'switch',
                'title' => esc_html__('Hide Footer', 'Galileo'),
                'default' => 0,
            ),
            array(
                'id' => 'copyright_text',
                'type' => 'textarea',
                'title' => esc_html__('Copyright Text', 'Galileo'),
                'default' => '<li> &copy; <a href="' . esc_url( esc_html__('http://Galileo-intl.com/', 'Galileo')) . '">' . esc_html__('Massive Solutions','Galileo').'</a>' . esc_html__(' 2016 - ','Galileo').'</li>
                <li>Developed by <a href="' . esc_url( esc_html__('http://massive-solutions.com', 'Galileo')) . '">' . esc_html__('Galileo','Galileo').'</a></li>'
            )
        )
    )); //footer
