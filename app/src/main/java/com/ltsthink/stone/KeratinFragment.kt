...
<<<<<<< HEAD
            ...
            if (UserInfo.client_id != 0) {
                ...
                val req = JsonObjectRequest(Request.Method.POST, url2, keratinObj,
                        Response.Listener { response ->
                            if (response.getString("success") != "0") {
                                ...
                                val req = JsonObjectRequest(Request.Method.POST, url, jsonObj,
                                        Response.Listener { response ->
                                            if (response.getString("hair_specialist_name") == "") {
                                                Toast.makeText(context, "fill hair specialist name", Toast.LENGTH_LONG).show()

                                            } else if (response.getString("product_name") == "") {
                                                Toast.makeText(context, "fill product name ", Toast.LENGTH_LONG).show()
