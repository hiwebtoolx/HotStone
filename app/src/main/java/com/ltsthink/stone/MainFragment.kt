...
class MainFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        v.historyBtn.setOnClickListener {

            val intent = Intent(context, HistoryActivity::class.java)
            intent.putExtra("historyBtn",1)
        ...
        if (clientName.text == "") {
            ...
            v.historyBtn.visibility = View.GONE
        }
...
//    }
    ...
    fun showUpdateUserDialog() {
        ...
        var url = Config.SITE_URL + "user/update-profile"
        val jsonObj = JSONObject()
        val context = this.context
        val builder = AlertDialog.Builder(context!!)
        builder.setTitle(getString(R.string.update_client))
        ...
        val emailEditText = view.findViewById(R.id.emailEditText) as EditText
        val phoneEditText = view.findViewById(R.id.PhoneEditText) as EditText
        nameEditText.setText(UserInfo.client_name)
        emailEditText.setText(UserInfo.client_email)
        phoneEditText.setText(UserInfo.client_phone)
        builder.setView(view)
        ...
        builder.setPositiveButton(android.R.string.ok) { dialog, p1 ->
            ...
            jsonObj.put("email", emailAddress)
            jsonObj.put("name", fullName)
            jsonObj.put("client_id", UserInfo.client_id)
            ...
            if (isValid) {
                ...
                val req = JsonObjectRequest(Request.Method.POST, url, jsonObj,
                        Response.Listener { response ->
                            client_info.visibility = View.GONE
                            clientBtn.visibility = View.GONE
                            update.visibility = View.GONE
                            Toast.makeText(context, "User is update successfully", Toast.LENGTH_LONG).show()
