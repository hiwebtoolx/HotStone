...
class Branch extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('stone', 'ID'),
            'title_en' => Yii::t('stone', 'Title En'),
            'title_ar' => Yii::t('stone', 'Title Ar'),
    ...
    /**
     * @inheritdoc
     * @return \backend\models\BranchQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \backend\models\BranchQuery(get_called_class());
