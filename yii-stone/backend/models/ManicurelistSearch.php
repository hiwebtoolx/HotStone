...
/**
 * backend\models\ManicurelistSearch represents the model behind the search form about `backend\models\Manicurelist`.
 */
 class ManicurelistSearch extends Manicurelist
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'checked_by', 'created_at', 'updated_at', 'created_by', 'updated_by', 'deleted_at', 'deleted_by'], 'integer'],
