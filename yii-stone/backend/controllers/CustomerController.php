...
class CustomerController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'save-as-new', 'add-address'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    /**
     * 
     * Export Customer information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new Customer model by another data,
