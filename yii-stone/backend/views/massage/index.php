...
$this->title = Yii::t('stone', 'Massages');
...
<div class="massage-index">
    ...
    <p>
        <?= Html::a(Yii::t('stone', 'Create Massage'), ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
            ...
            'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-massage-search-created_by']
        ],
        [
        ...
        [
            ...
            'filterInputOptions' => ['placeholder' => 'Branch', 'id' => 'grid-massage-search-branch_id']
        ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-massage-search-user_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-massage']],
        'panel' => [
