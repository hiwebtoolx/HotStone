...
/* @var $model backend\models\SalonareaSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-salonarea-search">
    ...
    <?php /* echo $form->field($model, 'shampoo_sweep_and_mop_floors')->textInput(['placeholder' => 'Shampoo Sweep And Mop Floors']) */ ?>

    <?php /* echo $form->field($model, 'shampoo_clean_under_chairs_from_hair_and_put_leader')->textInput(['placeholder' => 'Shampoo Clean Under Chairs From Hair And Put Leader']) */ ?>
