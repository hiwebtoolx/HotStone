...
/* @var $searchModel backend\models\SpaSearch */
...
<div class="spa-index">
    ...
    <p>
        <?= Html::a(Yii::t('stone', 'Create Spa'), ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-spa-search-checked_by']
            ],
        [
            'attribute' => 'branch_id',
            ...
            'filterInputOptions' => ['placeholder' => 'Branch', 'id' => 'grid-spa-search-branch_id']
        ],
        'shift_am',
        'shift_pm',
        'shift_date',
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-spa']],
        'panel' => [
