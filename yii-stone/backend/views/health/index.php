...
$this->title = Yii::t('stone', 'Healths');
...
<div class="health-index">
    ...
    <p>
        <?= Html::a(Yii::t('stone', 'Create Health'), ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-health-search-user_id']
            ],
        [
            'attribute' => 'branch_id',
            ...
            'filterInputOptions' => ['placeholder' => 'Branch', 'id' => 'grid-health-search-branch_id']
        ],
        [
            'attribute' => 'created_by',
            'label' => Yii::t('stone', 'Created By'),
            'value' => function($model){
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-health']],
        'panel' => [
