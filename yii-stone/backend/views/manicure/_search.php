...
/* @var $model backend\models\ManicureSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-manicure-search">
    ...
    <?php /* echo $form->field($model, 'read_salon_logbook_hand_over_and_plan_the_day2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'clean_sanitize_and_organize_salon_station2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'receive_supplies_and_products_for_the_station2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'turn_on_equipment_when_necessary2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'sterilize_nipper_cuticle_nail_pusher_in_autoclave2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'make_sure_that_all_linens_to_be_used_at_that_station_are_fresh2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'organize_newspapers_magazines_promotional_materials2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'clean_and_wipe_pedicure_chairs_manicure_stations2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'clean_and_organize_nail_polish_racks2')->checkbox() */ ?>
    ...
    <?php /* echo $form->field($model, 'keep_consultation_forms_inside_drawers2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'prepare_consultations_forms_with_name_of_client_on_hard_doard2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'file_consultation_forms_after_finish2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'be_sure_services_try_and_bowls_are_clean_and_organized2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'check_baskets_of_technicien_are_clean_and_organized2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'clean_and_organize_drawers_as_training2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'services_try_should_be_clean_and_organized_and_no_damaged2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'check_cleaning_basket_for_each_station_clorox_fairy_detol2')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'wipe_pedicure_chair_with_conditionner2')->checkbox() */ ?>
