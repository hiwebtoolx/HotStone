...
if($providerProductionAreaOpening->totalCount){
    ...
    echo Gridview::widget([
        ...
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-production-area-opening']],
        'panel' => [
            'type' => GridView::TYPE_PRIMARY,
            'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode(Yii::t('stone', 'Production Area Opening')),
        ],
