...
/* @var $searchModel backend\models\ProductareaSearch */
...
$this->title = Yii::t('stone', 'Productareas');
...
?>
<div class="productarea-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('stone', 'Create Productarea'), ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-productarea-search-checked_by']
            ],
        'notes:ntext',
        'shift_am',
        'shift_pm',
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-productarea']],
        'panel' => [
