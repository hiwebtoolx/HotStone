...
<div class="productarea-form">
    ...
    <?= $form->field($model, 'clean_and_sanitize_sink')->checkbox() ?>

    <?= $form->field($model, 'draw_up_the_decoration')->checkbox() ?>

    <?= $form->field($model, 'clean_the_product_containers')->checkbox() ?>
