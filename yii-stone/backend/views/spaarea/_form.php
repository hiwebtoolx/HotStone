...
<div class="spaarea-form">
    ...
    <?= $form->field($model, 'makeup_sweep_and_mop_floors')->checkbox() ?>

    <?= $form->field($model, 'makeup_remove_stains_and_dust_on_surfaces')->checkbox() ?>

    <?= $form->field($model, 'makeup_empty_trush')->checkbox() ?>

    <?= $form->field($model, 'makeup_clean_and_sanitize_sink')->checkbox() ?>

    <?= $form->field($model, 'makeup_clean_mirrors')->checkbox() ?>
