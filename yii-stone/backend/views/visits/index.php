...
<div class="visits-index">
    ...
    <p>
        <?= Html::a(Yii::t('stone', 'Create Visits'), ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
            ...
            'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-visits-search-created_by']
        ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-visits-search-user_id']
            ],
        [
            'attribute' => 'branch_id',
            ...
            'filterInputOptions' => ['placeholder' => 'Branch', 'id' => 'grid-visits-list-search-branch_id']
        ]
        ,
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-visits']],
        'panel' => [
